    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.CharField(default='', max_length=500, verbose_name='消息')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_type', models.CharField(choices=[(1, '课程'), (2, '课程机构'), (3, '讲师')], default=1, max_length=5, verbose_name='收藏类型')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
